...
public class QueryDataConverter implements DataConverter<String, CallbackQueryDto> {
    public static final String DATA_DELIMITER = "&";
    public static final String NON_ARGS_DELIMITER = "@";

    @Override
    public String encode(CallbackQueryDto data) {
    ...
    @Override
    public CallbackQueryDto decode(String encoded) {
        ...
        return CallbackQueryDto.builder()
                .typeKey(nonArgs[0])
                .statusKey(nonArgs[1])
                .args(args).build();
    }
